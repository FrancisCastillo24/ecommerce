<x-admin-layout :breadcrumbs="[
    ...
    ['name' => $family->name], // Aquí muestro en el cabecera el nombre de la familia que hemos seleccionado a editar
]">
    ...
    <div class="card">
        ...
        <form action="{{ route('admin.families.update', $family) }}" method="post">
            ...
            <!-- Estos componentes están en views -> components para agregar campos y demás -->
            <div class="mb-4">
                <x-label class="mb-2 ">
                    Nombre
                </x-label>
