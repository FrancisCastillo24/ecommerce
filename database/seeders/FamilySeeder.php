...
class FamilySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // familias, categorias y subcategorias es el array anterior
        foreach ($families as $family => $categories) {
            
            // Obtengo las familias (nombre)
            $family = Family::create([
                'name' => $family,
            ]);

            // Obtengo las categorías (nombre y a que familia pertenece)
            ...
            // Obtengo las subcategorías (nombre y a que familia pertenece)
